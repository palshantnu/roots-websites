...
use App\Filament\Clusters\Research\Resources\SectionItemResource\Pages;
...
class SectionItemResource extends ResearchResource
{
    ...
    {
        return collect(config('sites.research.sections', []))
        ...
        return $form
            ...
            ->schema([
                Forms\Components\Select::make('section')
                    ...
                    ->required()
                    ->live()
                    ->helperText(fn (Forms\Get $get): ?string => config('sites.research.sections.'.$get('section').'.1'))
                    ->columnSpanFull(),
