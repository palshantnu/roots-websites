...
import { whyChooseUs, trustBadges } from "../../data/whyChooseUs";
        ...
        {whyChooseUs.map((item, i) => (
          <Reveal key={item.title} delay={i * 0.1}>
            ...
            >
              ...
              <div
                className={`-mt-6 flex h-12 w-12 items-center justify-center rounded-2xl shadow-md ${iconTone[item.tone]}`}
              >
              ...
              <span
                className={`mt-4 inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-bold ${statTone[item.tone]}`}
              >
                {item.stat}
              </span>
            </motion.div>
